...
contract BridgeBSC {
    ...
    BSCToken public bscToken;
    address backendSigner;
    uint256 nonce;

    mapping(uint256 => bool) private _nonces;

    constructor(address _bscToken, address _backendSigner) {
        bscToken = BSCToken(_bscToken);
    ...
    function swap(address _to, uint256 _amount, bytes calldata _signature) external {
        ...
        bscToken.burn(msg.sender, _amount);
